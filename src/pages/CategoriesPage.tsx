              ...
              <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                ...
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                    <motion.div
                      className="bg-white/90 backdrop-blur-sm text-gray-900 px-6 py-3 rounded-full font-semibold transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300"
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}

                    >
                      <Link to={`/category/${category.slug}`} className='flex items-center space-x-2'>
                        <span>Explore</span>
                ...
                <div className="p-6">
                  ...
                  <motion.div
                    className="text-primary-600 hover:text-primary-700 font-semibold text-sm group/link"
                    whileHover={{ x: 5 }}
                  >
                    <Link to={`/category/${category.slug}`} className='inline-flex items-center'>
                      <span>Shop Now</span>
